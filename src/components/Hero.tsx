...
export default function Hero() {
  ...
  return (
    <section className="relative pt-32 pb-0 overflow-hidden bg-white">
      ...
      {/* Very subtle teal tint at top */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] rounded-full pointer-events-none opacity-[0.07]"
      ...
      <div className="relative max-w-5xl mx-auto px-6 text-center">
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          <span className="badge-light mb-5 inline-flex items-center gap-2">
        ...
        >
          ...
          to Competitors Every Day —{" "}
          <span className="gradient-heading">We Fix That</span>
        </motion.h1>
        ...
        >
          After 100+ clinic audits, we find the same issues every time: invisible on Google, missed WhatsApp inquiries, and wasted ad spend. We solve all three — websites, ads, AI, SEO, EHR — under one roof.
        </motion.p>
        ...
        >
          ...
          <a href="https://wa.me/923207800010" target="_blank" rel="noopener noreferrer"
            className="flex items-center gap-2 text-sm font-semibold text-[#25D366] border border-[#25D366]/40 px-6 py-4 rounded-md hover:bg-[#25D366]/05 transition-colors w-full sm:w-auto justify-center">
        ...
        <motion.div
          ...
          className="flex flex-col sm:flex-row items-center justify-center gap-4 text-sm text-gray-400 mb-12"
        >
          <div className="flex items-center gap-1.5">
            <span className="text-amber-400 text-base">★★★★★</span>
            <span className="text-gray-600 font-semibold">4.9 / 5</span>
            <span>from 100+ clinic reviews</span>
          </div>
          <span className="hidden sm:block text-gray-200">|</span>
          <div className="flex items-center gap-1.5">
            <span className="text-[#00B4D8] font-semibold">NO LONG-TERM CONTRACTS</span>
          </div>
          <span className="hidden sm:block text-gray-200">|</span>
          <div className="flex items-center gap-1.5">
            <span className="text-gray-600 font-semibold">Results in 60 days</span>
          </div>
        </motion.div>
      </div>
