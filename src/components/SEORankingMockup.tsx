...
const results = [
  { name: "Generic Dental Directory", url: "dentaldirectory.co.uk", you: false },
  { name: "Competitor Clinic Manchester", url: "competitorclinic.co.uk", you: false },
  { name: "Your Clinic — Dental Implants Blackburn", url: "yourclinic.co.uk", you: true },
];
  ...
  return (
    <div ref={ref} className="rounded-2xl overflow-hidden shadow-2xl border border-gray-200 max-w-2xl mx-auto">
      <div className="bg-white px-5 py-3.5 border-b border-gray-100 flex items-center gap-2">
        ...
        <span className="text-sm text-gray-600">dental implants cost Blackburn</span>
      </div>
        ...
        {results.map((r, i) => {
          ...
          return (
            <motion.div key={r.name}
              ...
              <p className="text-xs text-gray-400 mt-0.5">★★★★★ 4.9 (210 reviews) — Trusted dental implant specialists in Blackburn. Free consultation available.</p>
            </motion.div>
          );
        })}
      </div>
