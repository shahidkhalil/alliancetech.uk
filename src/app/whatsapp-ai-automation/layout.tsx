...
export const metadata: Metadata = {
  ...
  keywords: ["WhatsApp AI automation", "AI automation for clinics Houston", "WhatsApp AI for clinics", "automated WhatsApp booking", "clinic WhatsApp chatbot", "AI patient messaging Texas"],
