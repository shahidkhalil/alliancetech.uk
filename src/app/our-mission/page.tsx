...
const beliefs = [
  ...
  { lead: "Local context isn't optional.", desc: "English, Blackburn and Manchester, the way UK patients actually search and book. Software built for another market and translated at the edges will always feel foreign here." },
  ...
  return (
    <PageWrapper>
      <ServicePageHero
        ...
        subheadline="The UK has thousands of skilled doctors running clinics that deserve to be full. We build the systems that make sure they are."
