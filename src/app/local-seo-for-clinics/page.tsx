...
const features = [
  ...
  { icon: "🔍", title: "Local Keyword Targeting", desc: "'Dentist near me', 'aesthetic clinic Blackburn' — we rank you for every local search your patients make." },
  { icon: "📄", title: "Local Landing Pages", desc: "Area-specific pages that rank for neighbourhood searches — Darwen, Accrington, Manchester, and more." },
  { icon: "🔗", title: "Citation & Link Building", desc: "50+ local directory listings and local backlinks that signal authority to Google." },
];

const stats = [
  { value: 1, prefix: "#", label: "Google Maps ranking" },
  { value: 60, label: "Days to results" },
  { value: 5, suffix: "x", label: "More local leads" },
  ...
  return (
    <PageWrapper>
      <ServicePageHero
        ...
        subheadline="When patients search 'dentist near me' or 'aesthetic clinic in Blackburn' — your clinic appears first. We make that happen in 60 days."
      ...
      <section className="py-14 bg-[#F8FAFC]">
        <Reveal className="max-w-4xl mx-auto px-6">
          <AnimatedSurface className="p-10 text-center border border-gray-100">
            ...
            <p className="text-sm text-gray-400 mb-6">Local SEO for clinics across the United Kingdom.</p>
